...
- Python 3.12+ (backend), TypeScript 5.x (auth-server & frontend) (013-hybrid-jwt-auth)
- Neon serverless PostgreSQL (shared database across auth-server and FastAPI backend) (013-hybrid-jwt-auth)
